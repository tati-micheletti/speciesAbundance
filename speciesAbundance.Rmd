...
If `sourceURL` is specified, `downloadData("speciesAbundance", "C:/Users/Tati/Documents/EFI")` may be sufficient.
...
df_inputs <- SpaDES.core::moduleInputs("speciesAbundance", "C:/Users/Tati/Documents/EFI")
...
Provide a summary of user-visible parameters (Table \@ref(tab:moduleParams-speciesAbundance))


```{r moduleParams-speciesAbundance, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_params <- SpaDES.core::moduleParams("speciesAbundance", "C:/Users/Tati/Documents/EFI")
